...
public class LTHKeychainUtils: NSObject {
    ...
    public class func getPasswordForUsername(_ username: String?, andServiceName serviceName: String?) throws -> String? {
        ...
        let attributeQuery: [String: Any] = [keys[0]: objects[0], keys[1]: objects[1], keys[2]: objects[3], (kSecReturnAttributes as String): true]
        ...
        let passwordQuery: [String: Any] = [keys[0]: objects[0], keys[1]: objects[1], keys[2]: objects[3], (kSecReturnData as String): true]
    ...
    class func storeUsername(_ username: String?, andPassword password: String?, forServiceName serviceName: String?, updateExisting: Bool) throws {
        ...
        if let existingPassword = existingPassword {
    ...
    class func deleteItem(forUsername username: String?, andServiceName serviceName: String?) throws {
        guard let username = username, let serviceName = serviceName else {
            throw NSError(domain: SFHFKeychainUtilsErrorDomain, code: -2000, userInfo: nil)
        }
